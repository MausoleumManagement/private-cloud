...
CLUSTER_API_VERSION="1.13.0" # github-releases/kubernetes-sigs/cluster-api&versioning=semver
...
CAPMOX_VERSION="0.7.7" # github-releases/ionos-cloud/cluster-api-provider-proxmox&versioning=semver
